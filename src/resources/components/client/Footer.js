			...
			<div className='container'>
				<div className='row'>
					<div className='col-md-4 mb-4'>
						<p className='font-sz-medium font-wg-500 mb-4'>
							Need My Travel Help?
						</p>

						<div>
							<p className='font-sz-normal color-grey-1'>
								Got Questions ? Call us 24/7
							</p>
							<p className='font-sz-normal color-danger-1 mt-1'>
								Call Us: (+250) 791 349 744
							</p>
						</div>
					...
					<div className='col-md-4 mb-4'>
						...
						<div className='mt-3'>
							<InputGroup>
								...
								<Button
									variant='default'
									className='bg-primary font-sz-normal text-white'
								>
									Subscribe
								</Button>
							</InputGroup>
				...
				<div className='row mt-1'>
					<div className='col-md-12 mt-5'>
						<p className='color-dark font-sz-normal text-center'>
							Copyright &copy; 2022 GoDiscoverAfrica. Allrights Reserved
						</p>
					</div>
				</div>
			</div>
